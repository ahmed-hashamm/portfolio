...
export function ProjectCard({img,title,description,className,link}) {
  return (
    <div className={` flex flex-col md:flex-row justify-center items-center md:justify-between md:p-16 mt-32 ${className}`}>
...
className="hover:text-blue-500  font-bold cursor-pointer flex justify-center items-center gap-1" href={link}>Visit<MdArrowOutward /></a>
    ...
    <div className="tech mt-14 md:mt-0">
      ...
      <div className="images flex flex-wrap max-w-[500px] justify-center  gap-2 mt-10">
        <div className="w-20 h-20 rounded-full ring-2 p-2 flex justify-center items-center">
          <img className="w-18 object-contain object-center" src={react} alt="react" />
        </div>
        <div className="w-20 h-20 rounded-full ring-2 ring-red-500  flex justify-center items-center">
          <img  className="w-18 object-center"src={html} alt="html" />
        </div>
        <div className="w-20 h-20 rounded-full ring-blue-600 ring-2 p-2 flex justify-center items-center">
          <img className="w-12 object-contain object-center" src={css} alt="css" />
        </div>
        <div className="w-20 h-20 rounded-full ring-blue-500  ring-2 p-2 flex justify-center items-center">
          <img className="w-16 object-contain object-center" src={tailwind} alt="tailwind" />
        </div>
        <div className="w-20 h-20 rounded-full ring-2 ring-yellow-600  p-2 flex justify-center items-center">
          <img className="w-18 object-contain object-center" src={js} alt="javascript" />
        </div>
        <div className="w-20 h-20 rounded-full ring-2 ring-violet-600  p-2 flex justify-center items-center">
          <img className="w-18 object-contain object-center" src={framer} alt="framerMotion" />
        </div>
        <div className="w-20 h-20 rounded-full ring-2 ring-orange-600  p-2 flex justify-center items-center">
          <img className="w-14 object-contain object-center" src={firebase} alt="framerMotion" />
        </div>
